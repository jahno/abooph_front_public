...
function OrderSuccess(props){
    ...
    if(!order) history.replace('/')
    
    const { numeroCommande: transactionId, panier: { articles: cartItems }, total, livraison: shipping, adresse, paiement, date_livraison } = order
                            ...
                            <div className="product-order">
                                ...
                                <div className="total-sec">
                                    <ul>
                                        ...
                                        <li>Sous-total <span>{total} F</span></li>
                                        <li>livraison <span>{shipping} F</span></li>
                                    </ul>
                                </div>
                                <div className="final-total">
                                    {/* <h3>total <span><NumberFormat value={total + parseInt(shipping)} displayType={"text"} thousandSeparator={" "}/> F</span></h3> */}
                                    <h3>total <span>{total + parseInt(shipping)} F</span></h3>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
