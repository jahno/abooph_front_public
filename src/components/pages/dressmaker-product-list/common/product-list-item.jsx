                                        ...
                                        <div className="col-lg-6 rtl-text">
                                            <div className="product-right">
                                                ...
                                                <div className="product-description border-product">
                                                    ...
                                                    {/* <Link to={`${process.env.PUBLIC_URL}/couturier/${product.couturier_id}`} style={{color: 'red', cursor: 'pointer'}}>{product.couturier.nom} {product.couturier.prenom}</Link> */}
                                                    {/* <br/><br/> */}
                                                ...
                                                <div className="product-buttons">
                                                    <button  className="btn btn-solid" onClick={() => onAddToCartClicked(product, this.state.quantity)} >ajouter au panier</button>
